-- Update the handle_new_user trigger function to include subTab parameter in notification link
...
BEGIN
  ...
  IF NEW.raw_user_meta_data ->> 'upline_eq_id' IS NOT NULL AND NEW.raw_user_meta_data ->> 'upline_eq_id' != '' THEN

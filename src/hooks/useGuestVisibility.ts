...
const DEFAULT_GLOBAL: GuestConfig = {
  sidebar: { items: { dashboard: true, support: true, news: false, knowledge: false, settings: false, paidEvents: true } },
  ...
  widgets: { newsBanner: false, infoBanners: false, map: false, newsTicker: false, introVideo: false, calendar: true, webinarInvite: false, myMeetings: false, trainingProgress: false, otpCodes: false, resources: false, teamContacts: false, reflinks: false, infoLinks: false, footer: true, footerQuote: false, footerMap: false, footerTeam: true, footerContact: true, footerBottom: true, calendarLegend: false, pwaInstall: false },

...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div className="w-full max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 min-h-screen relative">

...
const HealthyKnowledgePage: React.FC = () => {
  ...
  return (
    <DashboardLayout title={tf('hk.pageTitle', 'Baza wiedzy')} backTo={{ label: 'Strona główna', path: '/dashboard' }}>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">{tf('hk.pageTitle', 'Baza wiedzy')}</h1>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            {previewMaterial?.description && (
              <DialogDescription className="text-sm">{previewMaterial.description}</DialogDescription>
            )}
          </DialogHeader>

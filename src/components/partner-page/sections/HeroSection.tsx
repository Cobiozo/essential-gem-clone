          ...
          <div className={isFullBleed ? 'lg:max-w-[50%]' : 'grid md:grid-cols-2 gap-8 items-center'}>
            <div className="space-y-6">
              ...
              {config.partner_badge && (config.partner_badge.text || config.partner_badge.subtitle) && (
                <div className="flex items-center gap-2 sm:gap-3 backdrop-blur-sm px-3 py-2 sm:px-4 sm:py-3 rounded-2xl max-w-fit shadow-lg" style={{ backgroundColor: config.partner_badge.bg_color || 'rgba(255,255,255,0.9)' }}>
                  ...
                  <div>
                    {config.partner_badge.text && (
                      <p className="text-xs font-medium" style={{ color: config.partner_badge.text_color || '#6b7280' }}>{config.partner_badge.text}</p>
                    )}
                    {config.partner_badge.subtitle && (
                      <p className="text-sm font-semibold" style={{ color: config.partner_badge.text_color || '#111827' }}>{config.partner_badge.subtitle}</p>
                    )}
                  </div>
                </div>
              )}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center py-16">
        ...
        {config.partner_badge && (config.partner_badge.text || config.partner_badge.subtitle) && (
          <div className="inline-flex items-center gap-3 backdrop-blur-sm px-4 py-3 rounded-2xl shadow-lg mb-4" style={{ backgroundColor: config.partner_badge.bg_color || 'rgba(255,255,255,0.9)' }}>
            {config.partner_badge.avatar_url && (

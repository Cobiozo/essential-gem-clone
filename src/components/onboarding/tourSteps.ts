...
export const tourSteps: TourStep[] = [
  ...
  {
    id: 'reflinks-widget',
    targetSelector: '[data-tour="reflinks-widget"]',
    title: '🔗 PureLinki (widget)',
    description: 'Twoje unikalne linki polecające — skopiuj link jednym kliknięciem i wyślij go potencjalnym partnerom lub klientom. Statystyki kliknięć pokazują skuteczność każdego linku.',
    position: 'bottom',
    visibleFor: partnerPlus,
    scrollTo: true,
  },
  {
    id: 'infolinks-widget',
    targetSelector: '[data-tour="infolinks-widget"]',
    title: '🔗 InfoLinki (widget)',
    description: 'Linki do chronionych treści z kodami OTP. Udostępnij link zainteresowanej osobie — po wpisaniu kodu OTP uzyska dostęp do materiałów edukacyjnych.',
    position: 'bottom',
    visibleFor: partnerPlus,
    scrollTo: true,
  },
  {
    ...
    title: '🧬 Zdrowa Wiedza (widget)',
    description: 'Wyróżnione materiały edukacyjne o zdrowiu. Przeglądaj artykuły i udostępniaj je innym za pomocą kodów OTP ze swojego panelu.',
    position: 'bottom',
    visibleFor: partnerPlus,
    scrollTo: true,
  },
  ...
  },
  {
    ...
    title: '🧬 Zdrowa Wiedza',
    description: 'Biblioteka materiałów o zdrowiu — artykuły, filmy i infografiki. Możesz je przeglądać i udostępniać swoim kontaktom za pomocą kodów OTP.',
    position: 'right',
    visibleFor: partnerPlus,
  },
  {
  ...
  },
  {
    ...
    title: '🔗 PureLinki',
    description: 'Generuj unikalne linki polecające — każdy link śledzi kliknięcia. Skopiuj i wyślij link osobie, którą chcesz zaprosić na platformę.',
    position: 'right',
    visibleFor: partnerPlus,
  },
  {
    ...
    title: '🔗 InfoLinki',
    description: 'Twórz linki z kodem OTP do chronionych treści. Odbiorca wpisuje kod jednorazowy, aby obejrzeć materiały. Idealne do bezpiecznego dzielenia się wiedzą.',
    position: 'right',
    visibleFor: partnerPlus,
  },
  {

...
interface EqologyTemplateManagerProps {
  data: EqologyTemplateData;
  onChange: (data: EqologyTemplateData) => void;
}

export const EqologyTemplateManager: React.FC<EqologyTemplateManagerProps> = ({ data, onChange }) => {

  ...
  return (
    <div className="h-full flex flex-col bg-background border-l overflow-hidden">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
        <TabsList className="w-full grid grid-cols-4 h-9 rounded-none border-b shrink-0">
        ...
        <TabsContent value="content" className="flex-1 m-0 overflow-hidden">
          <ScrollArea className="h-full">
            <div className="p-2 space-y-1">
              ...
              {/* Accessibility */}
              <CollapsibleSection title="Dostępność" icon={<Settings className="w-4 h-4" />} defaultOpen={false}>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <Label className="text-xs">Atrybut title (tooltip)</Label>
                    <Input
                      value={element.attributes.title || ''}
                      onChange={(e) => updateAttribute('title', e.target.value)}
                      placeholder="Podpowiedź po najechaniu"
                      className="text-sm"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Opis dla czytników"
                      className="text-sm"
                    />
                  </div>
                </div>
        ...
        <TabsContent value="styles" className="flex-1 m-0 overflow-hidden">
          <ScrollArea className="h-full">
            <div className="p-2 space-y-1">
              ...
              <CollapsibleSection title="Typografia" icon={<Bold className="w-4 h-4" />}>
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={element.styles.textTransform || ''} 
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="capitalize">Pierwsza Wielka</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="none">None (ukryty)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="row">Row (poziomo)</SelectItem>
                        <SelectItem value="row-reverse">Row reverse</SelectItem>
                        <SelectItem value="column">Column (pionowo)</SelectItem>
              ...
              {/* Position & Overflow */}
              <CollapsibleSection title="Pozycjonowanie" icon={<Box className="w-4 h-4" />} defaultOpen={false}>
                <div className="space-y-3">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(v) => updateStyle('cursor', v)}
                    >
                      <SelectTrigger className="text-sm">
                        <SelectValue placeholder="Wybierz" />
                      </SelectTrigger>
              ...
              {elementType === 'container' && (
                <CollapsibleSection title="Tło kontenera" icon={<Image className="w-4 h-4" />}>
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs">Powtarzanie tła</Label>
                      <Select 
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="no-repeat">Bez powtarzania</SelectItem>
                          <SelectItem value="repeat">Powtarzaj</SelectItem>
                          <SelectItem value="repeat-x">Powtarzaj X</SelectItem>
                          <SelectItem value="repeat-y">Powtarzaj Y</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    <div className="space-y-2">
                      ...
                      <Select 
                        value={element.styles.backgroundAttachment || 'scroll'} 
                        onValueChange={(v) => updateStyle('backgroundAttachment', v)}
                      >
                        <SelectTrigger className="text-sm">
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select 
                        value={element.styles.backgroundBlendMode || ''} 
                        onValueChange={(v) => updateStyle('backgroundBlendMode', v)}
                      >
                        <SelectTrigger className="text-sm">
          ...
          <ScrollArea className="h-full">
            <div className="p-2 space-y-1">
              ...
              <CollapsibleSection title="Efekty" icon={<Wand2 className="w-4 h-4" />}>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <Label className="text-xs">Cień (box-shadow)</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs">Cień tekstu</Label>
                    <Input
                      value={element.styles.textShadow || ''}
              ...
              {/* Filters & Animations */}
              <CollapsibleSection title="Filtry i animacje" icon={<Sparkles className="w-4 h-4" />} defaultOpen={false}>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <Label className="text-xs">Filter CSS</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={element.styles.mixBlendMode || ''} 
                      onValueChange={(v) => updateStyle('mixBlendMode', v)}
                    >
                      <SelectTrigger className="text-sm">
                        <SelectValue placeholder="Normal" />
                      </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs">Animacja (Tailwind class)</Label>
                    <Select 
                      value={element.attributes.class?.includes('animate-') ? element.attributes.class.match(/animate-\w+/)?.[0] || '' : ''} 
                      onValueChange={(v) => {
                        const currentClass = element.attributes.class || '';
                        const newClass = currentClass.replace(/animate-\w+/g, '').trim() + (v ? ` ${v}` : '');
                        updateAttribute('class', newClass.trim());
                      }}
                    >
                      <SelectTrigger className="text-sm">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="animate-scale-in">Scale In</SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={element.styles.pointerEvents || ''} 
                      onValueChange={(v) => updateStyle('pointerEvents', v)}
                    >
                      <SelectTrigger className="text-sm">
                      ...
                      <SelectContent>
                        <SelectItem value="auto">Auto</SelectItem>
                        <SelectItem value="none">None (nieaktywne)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={element.styles.userSelect || ''} 
                      onValueChange={(v) => updateStyle('userSelect', v)}
                    >
                      <SelectTrigger className="text-sm">
                        <SelectValue placeholder="Auto" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="auto">Auto</SelectItem>
                        <SelectItem value="none">None (nie zaznaczaj)</SelectItem>
                        <SelectItem value="text">Text</SelectItem>

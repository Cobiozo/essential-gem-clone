          ...
          <div className="hidden md:flex items-center gap-4 text-sm text-muted-foreground flex-shrink-0">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>
                ...
                <span className="ml-1">({getTimezoneLabel(eventTimezone, 'short')})</span>
              </span>
            </div>
          </div>
        ...
        <CollapsibleContent className="px-4 pb-4 border-t">
          <div className="pt-4 space-y-4">
            ...
            <div className="md:hidden flex items-center gap-4 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                <Clock className="h-4 w-4" />
                <span>{formatInTimeZone(startDate, eventTimezone, 'HH:mm')} - {formatInTimeZone(endDate, eventTimezone, 'HH:mm')} ({getTimezoneLabel(eventTimezone, 'short')})</span>
              </div>
            </div>
